    ...
    public partial class DashboardForm : UserControl
    {
        ...
        public void displayTotalES()
        {
            if(connect.State != ConnectionState.Open)
            {
                ...
                {
                    connect.Open();
                    string selectData = "SELECT COUNT(id) FROM students WHERE student_status = 'Enrolled'";
        ...
        public void displayTotalTT()
        {
            if (connect.State != ConnectionState.Open)
            {
                ...
                {
                    connect.Open();
                    string selectData = "SELECT COUNT(id) FROM teachers WHERE teacher_status = 'Active'";
