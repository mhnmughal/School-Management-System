                    ...
                    try
                    {
                        ...
                        using (SqlCommand checkSID = new SqlCommand(checkStudentID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"G:\#Whatsapp_Work\School-Management-System-using-CSharp-main\SchoolMangementSystem\SchoolMangementSystem\Student\", student_id.Text.Trim() + ".jpg");
