...
namespace SchoolMangementSystem
{
    public partial class AddTeachersForm : UserControl
    {
                        ...
                        using(SqlCommand checkTID = new SqlCommand(checkTeacherID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string insertData = "INSERT INTO teachers " +
                                    ...
                                    "teacher_image, teacher_status,teacher_course) " +
                                    "VALUES(@teacherID, @teacherName, @teacherGender, @teacherAddress," +
                                    "@teacherImage, @teacherStatus,@teacherCourse)";

                                // TO SAVE TO YOUR DIRECTORY
                                string path = Path.Combine(@"G:\#Whatsapp_Work\School-Management-System-using-CSharp-main\SchoolMangementSystem\SchoolMangementSystem\Teacher\", teacher_id.Text.Trim() + ".jpg");
                                ...
                                using(SqlCommand cmd = new SqlCommand(insertData, connect))
                                {
                                    ...
                                    cmd.Parameters.AddWithValue("@teacherCourse", teacher_courses.Text.Trim());
                                    cmd.ExecuteNonQuery();
        ...
        public void clearFields()
        {
            ...
            teacher_image.Image = null;
            imagePath = "";
            teacher_courses.SelectedIndex = -1;
        }
